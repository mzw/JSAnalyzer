...
public class XMLAttr {
	 ...
	 * Rule
	 */
	public static final String RuleEvent		 	= "event";
	public static final String RuleInteract 		= "interact";
	public static final String RuleInteract_User	= "User";
	public static final String RuleInteract_Server	= "Server";
	public static final String RuleIntreact_Self	= "Self";
