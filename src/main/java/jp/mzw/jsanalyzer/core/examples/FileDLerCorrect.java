...
public class FileDLerCorrect extends Project {
	...
	public static void main(String[] args) {
		Project project = new FileDLerCorrect();
...
//		verifier.setup();
		List<Specification> specList = FileDLerCorrect.getSpecList(analyzer, verifier.getExtractedFSM());
 		verifier.verifyIADP(specList);
	}
	
	public FileDLerCorrect() {
		super("FileDLerCorrect",
				"http://mzw.jp/yuta/research/ex/fd/motivatingExample.html",
