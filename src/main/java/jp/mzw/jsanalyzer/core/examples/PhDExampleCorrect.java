...
public class PhDExampleCorrect extends Project {

	public static void main(String[] args) {
		Project project = new PhDExampleCorrect();
...
////		verifier.setup();
// 		verifier.verifyIADP();
		List<Specification> specList = PhDExampleCorrect.getSpecList(analyzer, verifier.getExtractedFSM());
 		verifier.verifyIADP(specList);
	}

	public PhDExampleCorrect() {
		super("PhDExampleCorrect",
				"http://mzw.jp/yuta/research/ex/phd/example/correct.html",
