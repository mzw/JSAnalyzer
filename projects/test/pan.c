...
short src_ln1 [] = {
	  0, 370, 370, 371, 373, 373, 374, 374, 
	375, 375, 376, 376, 377, 377, 378, 378, 
	379, 379, 380, 380, 372, 382, 369, 383, 
	368, 384, 368, 384,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "Test.pml", 1, 27 },
...
short src_ln0 [] = {
	  ...
	  0,   0,  53,  60,  62,  63,   0,   0, 
	  0,  64,  71,  73,  74,   0,   0,   0, 
	 75,  80,  81,  82,   0,   0,   0,  83, 
	 88,  89,  90,   0,   0,   0,  91,  98, 
	100, 101,   0,   0,   0, 102, 109, 111, 
	112,   0,   0,   0, 113, 120, 122, 123, 
	  0,   0,   0, 124, 129, 130, 131,   0, 
	  0,   0, 132, 137, 138, 139,   0,   0, 
	  0, 140, 145, 146, 147,   0,   0,   0, 
	148, 155, 157, 158,   0,   0,   0, 159, 
	164, 165, 166,   0,   0,   0, 167, 172, 
	173, 174,   0,   0,   0, 175, 180, 181, 
	182,   0,   0,   0, 183, 188, 189, 189, 
	156, 191, 154, 192, 154, 192, 192, 121, 
	194, 119, 195, 119, 195, 196,   0,   0, 
	  0, 197, 204, 206, 207,   0,   0,   0, 
	208, 213, 214, 215,   0,   0,   0, 216, 
	221, 222, 223,   0,   0,   0, 224, 229, 
	230, 231,   0,   0,   0, 232, 237, 238, 
	238, 205, 240, 203, 241, 203, 241, 242, 
	  0,   0,   0, 243, 248, 249, 249, 110, 
	251, 108, 252, 108, 252, 253,   0,   0, 
	  0, 254, 259, 260, 261,   0,   0,   0, 
	262, 267, 268, 269,   0,   0,   0, 270, 
	275, 276, 277,   0,   0,   0, 278, 283, 
	284, 284,  99, 286,  97, 287,  97, 287, 
	288,   0,   0,   0, 289, 294, 295, 295, 
	 72, 297,  70, 298,  70, 298, 299,   0, 
	  0,   0, 300, 305, 306, 307,   0,   0, 
	  0, 308, 313, 314, 315,   0,   0,   0, 
	316, 321, 322, 323,   0,   0,   0, 324, 
	329, 330, 330,  61, 332,  59, 333,  59, 
	333, 334,   0,   0,   0, 335, 340, 341, 
	342,   0,   0,   0, 343, 348, 349, 350, 
	  0,   0,   0, 351, 356, 357, 357,  50, 
	359,  48, 360,  48, 360, 360,  39, 362, 
	 37, 363,  37, 364, 365,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 3 },
	{ "Test.pml", 4, 7 },
...
{
		now.flg_exit = 0;
		now.App_ch = addqueue(calling_pid, 1, 1);
		App_state = 0;
		now.App_event = 0;
		now.Int_event = 0;
#ifdef VAR_RANGES
		logval("flg_exit", now.flg_exit);
...
{	int i = 0;
	...
	{	if (t->ty[i] == TIMEOUT_F) return 1;
		...
		switch (t->qu[i]) {
		case 0: break;
		case 1: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.App_ch) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.App_ch) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.App_ch) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.App_ch) )))
			    ) return 0; break;
...
{	/* int i; */
	printf("global vars:\n");
	printf("	chan App_ch (=%d):	len %d:\t", now.App_ch, q_len(now.App_ch));
	c_chandump(now.App_ch);
	printf("	bit    flg_exit:	%d\n", now.flg_exit);
}
void
...
{
	switch (x) {
	case 1: Printf("__exit__"); break;
	case 2: Printf("tryLogout"); break;
	case 3: Printf("alert_480"); break;
	case 4: Printf("tryLogin"); break;
	case 5: Printf("validateLogin"); break;
	case 6: Printf("handleHttpGetSeed"); break;
	case 7: Printf("getSeed"); break;
	case 8: Printf("onGood"); break;
	case 9: Printf("Nameless_48"); break;
	case 10: Printf("_init"); break;
	case 11: Printf("__empty__"); break;
	case 12: Printf("onload"); break;
	case 13: Printf("User_Click"); break;
	case 14: Printf("onfocus"); break;
	case 15: Printf("onSuccess"); break;
	case 16: Printf("onmousedown"); break;
	case 17: Printf("onComplete"); break;
	case 18: Printf("onmouseup"); break;
	case 19: Printf("onclick"); break;
	default: Printf("%d", x);
	}
}
void
