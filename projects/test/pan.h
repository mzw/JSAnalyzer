...
#define nstates2	9	/* never_0 */
#define minseq2	335
#define maxseq2	342
#define endstate2	8

#define nstates1	28	/* Interaction */
#define minseq1	308
#define maxseq1	334
#define endstate1	27

#define nstates0	309	/* App */
#define minseq0	0
#define maxseq0	307
#define endstate0	308
...
#define PInteraction	((P1 *)this)
typedef struct P1 { /* Interaction */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
#define HAS_TRACK	0
/* hidden variable: */	uchar App_state;
