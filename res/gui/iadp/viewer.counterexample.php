...
window.onload = function() {
	...
	document.getElementById("view").src = "result/" + projName + "/counterexample/" + projName + ".spec." + specId + ".step.0.dot.png";
}
function goPrev() {
	if(0 < step) {
		document.getElementById("view").src = "result/" + projName + "/counterexample/" + projName + ".spec." + specId + ".step." + --step + ".dot.png";
